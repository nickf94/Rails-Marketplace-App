...
class ShoppingCartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_cart" do
    assert_difference('ShoppingCart.count') do
      post shopping_carts_url, params: { shopping_cart: { first_name: @shopping_cart.first_name, last_name: @shopping_cart.last_name, price: @shopping_cart.price } }
    end
  ...
  test "should update shopping_cart" do
    patch shopping_cart_url(@shopping_cart), params: { shopping_cart: { first_name: @shopping_cart.first_name, last_name: @shopping_cart.last_name, price: @shopping_cart.price } }
